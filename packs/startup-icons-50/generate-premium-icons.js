...
// 40 High-End Startup/SaaS Icons (Lucide/Feather style, 24x24, 2px stroke, viewBox="0 0 24 24", fill="none", stroke="currentColor")
const icons = {
  rocket: '<path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2l.5-.5a5.4 5.4 0 0 0 5.4 0l.5.5c1.26 1.5 5 2 5 2s-.5-3.74-2-5l-.5-.5a5.4 5.4 0 0 0 0-5.4l-.5-.5C14.74 3.5 11 3 11 3s-3.74.5-5 2l-.5.5a5.4 5.4 0 0 0 0 5.4l-.5.5Z"/><path d="m12 15 3.5-3.5"/><path d="M2 22v-3l4-4 3 3-4 4H2Z"/><path d="M22 2h-3l-4 4 3 3 4-4V2Z"/>',
  zap: '<polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/>',
  cpu: '<rect x="4" y="4" width="16" height="16" rx="2" ry="2"/><rect x="9" y="9" width="6" height="6"/><line x1="9" y1="1" x2="9" y2="4"/><line x1="15" y1="1" x2="15" y2="4"/><line x1="9" y1="20" x2="9" y2="23"/><line x1="15" y1="20" x2="15" y2="23"/><line x1="20" y1="9" x2="23" y2="9"/><line x1="20" y1="14" x2="23" y2="14"/><line x1="1" y1="9" x2="4" y2="9"/><line x1="1" y1="14" x2="4" y2="14"/>',
  database: '<ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M21 12c0 1.66-4 3-9 3s-9-1.34-9-3"/><path d="M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5"/>',
  cloud_upload: '<path d="M20 16.2A5 5 0 0 0 18 7h-1.26A8 8 0 1 0 4 15.2"/><polyline points="16 16 12 12 8 16"/><line x1="12" y1="12" x2="12" y2="21"/>',
...
const fullSvgHeader = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">';
const fullSvgFooter = '</svg>';

let count = 0;
for (const [name, pathData] of Object.entries(icons)) {
  const filePath = path.join(STATIC_DIR, `${name}.svg`);
  fs.writeFileSync(filePath, `${fullSvgHeader}${pathData}${fullSvgFooter}`);
  count++;
}

console.log(`Generated ${count} premium SVG icons in /static!`);
